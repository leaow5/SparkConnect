...
import com.spark.utils.concurrent.FastThreadLocalThread;
...
public class InternalThreadLocalMap extends UnpaddedInternalThreadLocalMap {
	...
	// With CompressedOops enabled, an instance of this class should occupy at
	// least 128 bytes.
	...
	public Map<Class<?>, Boolean> handlerSharableCache() {
		...
		if (cache == null) {
			// Start with small capacity to keep memory overhead as low as
			// possible.
	...
	/**
	 * @return {@code true} if and only if a new thread-local variable has been
	 *         created
	 */
