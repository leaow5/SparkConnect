...
public final class CharsetUtil {
	...
	/**
	 * Returns a new {@link CharsetEncoder} for the {@link Charset} with
	 * specified error actions.
	 *
	 * @param charset
	...
	/**
	 * Returns a new {@link CharsetEncoder} for the {@link Charset} with the
	 * specified error action.
	 *
	 * @param charset
	 *            The specified charset
	 * @param codingErrorAction
	 *            The encoder's action for malformed-input and
	...
	/**
	 * Returns a new {@link CharsetDecoder} for the {@link Charset} with
	 * specified error actions.
	 *
	 * @param charset
	 *            The specified charset
	...
	/**
	 * Returns a new {@link CharsetDecoder} for the {@link Charset} with the
	 * specified error action.
	 *
	 * @param charset
	 *            The specified charset
	 * @param codingErrorAction
	 *            The decoder's action for malformed-input and
	 *            unmappable-character errors
	 * @return The decoder for the specified <code>charset</code>
	 */
